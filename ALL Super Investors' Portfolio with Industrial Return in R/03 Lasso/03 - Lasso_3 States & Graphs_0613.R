...
find_Rp = function(lasso.coef){
  ...
  write.csv(as.data.frame(weight), file = "R output/weight_found.csv")
...
# Sharpe Ratio: LPC
(mean(na.omit(1+Test_table$LPC/100)^12)-1) - mean(na.omit((1+fama$RF[fama$Date>="2008-01-01"]/100)^12)-1)
sd((na.omit(1+Test_table$LPC/100)^12)-1)
sharpe_LPC = ((mean(na.omit(1+Test_table$LPC/100)^12)-1) - mean(na.omit((1+fama$RF[fama$Date>="2008-01-01"]/100)^12)-1))/sd((na.omit(1+Test_table$LPC/100)^12)-1)
cat("The Sharpe Ratio of Self-Concstructed Portfolio is: ", sharpe_self, 
    "\n",
    "The Sharpe Ratio of LPC is: ", sharpe_LPC)
...
# LPC
sd(na.omit(((1+Test_table$LPC[Test_table$rSP500<lower_threshold]/100)^12)-1))
sortino_LPC = ((mean(na.omit(1+Test_table$LPC/100)^12)-1) - mean(na.omit((1+fama$RF[fama$Date>="2008-01-01"]/100)^12)-1))/sd(na.omit(((1+Test_table$LPC[Test_table$rSP500<lower_threshold]/100)^12)-1))
cat("The Sortino Ratio of Self-Concstructed Portfolio is: ", sortino_self, 
    "\n",
    "The Sortino Ratio of LPC is: ", sortino_LPC)

# 輸出表格：Date, Rp_star, rSP500, rLPC
table_out = Test_table[Test_table$Date>="2008-01-01",c("Date", "rSP500", "Rp_star.normal", CertainInvestor)]
...
plot(Rp_star_date[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     main = "Performance", col = "blue", ylim = c(0.9,max(accum_price[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"][1])+0.1))
par(new=T)
plot(rSP500__date[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     type = 'l', xlab = "Previous 12 Months", 
     ylab = "Dollars (initial value = $1)",
     main = "Performance", col = "red",ylim = c(0.9,max(accum_price[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2018-12-01" & Rp_star_date<="2019-12-01"][1])+0.1))
legend("bottomright", legend = c("Self-Constructed Portfolio", "S&P500"),
       lty = c(1, 1), cex = 0.75,
       col = c(4, 2), text.col = c(4,2))
graphics.off()
...
plot(Rp_star_date[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     ylab = "Dollars (initial value = $1)",
     main = "Performance", col = "blue", ylim = c(0.9,max(accum_price[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"][1]))+0.1)
par(new=T)
plot(rSP500__date[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     type = 'l', xlab = "Previous 36 Months", 
     ylab = "Dollars (initial value = $1)",
     main = "Performance", col = "red",ylim = c(0.9,max(accum_price[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2016-12-01" & Rp_star_date<="2019-12-01"][1]))+0.1)
legend("bottomright", legend = c("Self-Constructed Portfolio", "S&P500"),
       lty = c(1, 1), cex = 0.75,
       col = c(4, 2), text.col = c(4,2))
graphics.off()
...
plot(Rp_star_date[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     ylab = "Dollars (initial value = $1)",
     main = "Performance", col = "blue", ylim = c(0.75,max(accum_price[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"][1]))+0.1)
par(new=T)
plot(rSP500__date[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"], 
     ...
     type = 'l', xlab = "Previous 60 Months", 
     ylab = "Dollars (initial value = $1)",
     main = "Performance", col = "red",ylim = c(0.75,max(accum_price[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"]/accum_price[Rp_star_date>="2014-12-01" & Rp_star_date<="2019-12-01"][1]))+0.1)
legend("bottomright", legend = c("Self-Constructed Portfolio", "S&P500"),
       lty = c(1, 1), cex = 0.75,
       col = c(4, 2), text.col = c(4,2))
graphics.off()
